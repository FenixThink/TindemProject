    ...
    INSERT INTO city VALUES ( null,"Armenia",1);
    INSERT INTO city VALUES ( null,"Barranquilla",1);
    INSERT INTO city VALUES ( null,"Bogotá D.C",1);
    ...
    INSERT INTO city VALUES ( null,"Aguachica",1);
    INSERT INTO city VALUES ( null,"Apartado",1);
    INSERT INTO city VALUES ( null,"Arauca",1);
    INSERT INTO city VALUES ( null,"Barrancabermeja",1);
    INSERT INTO city VALUES ( null,"Bello",1);
    INSERT INTO city VALUES ( null,"Buenaventura",1);
    INSERT INTO city VALUES ( null,"Buga",1);
    INSERT INTO city VALUES ( null,"Cartago",1);
    INSERT INTO city VALUES ( null,"Caucasia",1);
    INSERT INTO city VALUES ( null,"Cereté",1);
    INSERT INTO city VALUES ( null,"Chia",1);
    INSERT INTO city VALUES ( null,"Cinéga",1);
    INSERT INTO city VALUES ( null,"Floridablanca",1);
    INSERT INTO city VALUES ( null,"Florencia",1);
    INSERT INTO city VALUES ( null,"Girón",1);
    INSERT INTO city VALUES ( null,"Girardot",1);
    INSERT INTO city VALUES ( null,"Itagüí",1);
    INSERT INTO city VALUES ( null,"Monteria",1);
    INSERT INTO city VALUES ( null,"Neiva",1);
    INSERT INTO city VALUES ( null,"Ocaña",1);
    ...
    INSERT INTO profile_account VALUES (null,"Ana","Desarrolladora de software, Diseñadora y programadora de software para sistemas informáticos y dispositivos móviles.","applicant",1,"ana.jpg",1,7);
    INSERT INTO profile_account VALUES (null,"Pedro","Administrador de bases de datos, Gestiona, mantiene y actualiza bases de datos para asegurar la disponibilidad de la información.","applicant",2,"pedro.jpg",2,2);
    INSERT INTO profile_account VALUES (null,"Sofía","Ingeniera de redes, Planifica, implementa y mantiene redes de comunicaciones para empresas y organizaciones.","applicant",3,"sofia.jpg",3,2);
    INSERT INTO profile_account VALUES (null,"Luisa","Analista de seguridad informática, Evalua y fortalece la seguridad de los sistemas informáticos y redes de una empresa.","applicant",4,"luisa.jpg",4,6);
    INSERT INTO profile_account VALUES (null,"Martín","Especialista en inteligencia artificial, Desarrollador y diseñador de algoritmos y sistemas basados en inteligencia artificial para optimizar procesos y mejorar la toma de decisiones.","applicant",5,"martin.jpg",5,4);
    INSERT INTO profile_account VALUES (null,"Esteban","Gerente de operaciones, Planifica y supervisa el funcionamiento de las operaciones de la empresa, incluyendo la producción y distribución de productos o servicios.","applicant",6,"esteban.jpg",6,3);
    INSERT INTO profile_account VALUES (null,"Valeria","Analista de finanzas, Realiza análisis financieros para informar la toma de decisiones de inversión y financiamiento de la empresa.","applicant",7,"valeria.jpg",7,8);
    INSERT INTO profile_account VALUES (null,"Juan","Coordinador de recursos humanos, Gestiona la contratación, formación, desarrollo y retención de los empleados de la empresa.","applicant",8,"juan.jpg",8,4);
    INSERT INTO profile_account VALUES (null,"Karla","Especialista en marketing, Planifica y ejecuta estrategias de marketing para promover productos y servicios de la empresa.","applicant",9,"karla.jpg",9,11);
    INSERT INTO profile_account VALUES (null,"Santiago","Redactor de contenidos, Escribe textos para medios impresos y digitales como periódicos, revistas, sitios web, blogs y redes sociales.","applicant",10,"santiago.jpg",10,12);
    INSERT INTO profile_account VALUES (null,"Natalia","Relacionista público, Establece relaciones positivas y efectivas entre la empresa y los clientes, proveedores, comunidades y otros grupos de interés.","applicant",11,"natalia.jpg",11,10);
    INSERT INTO profile_account VALUES (null,"Daniel","Productor audiovisual, Crea y produce contenidos audiovisuales para la difusión de la marca o la empresa en diferentes medios.","applicant",12,"daniel.jpg",12,3);
    INSERT INTO profile_account VALUES (null,"Mariana","Soy Especialista en comercio exterior, Asesoro a empresas en el proceso de importación y exportación de productos y servicios.","applicant",13,"mariana.jpg",13,5);
    INSERT INTO profile_account VALUES (null,"Andrés","Especialista en inversiones, Asesora a empresas y particulares en la toma de decisiones de inversión.","applicant",14,"andres.jpg",14,4);
    INSERT INTO profile_account VALUES (null,"Sebastián","Guardia de seguridad: Experto en prevención de robos y vigilancia, apto para patrullar y garantizar la seguridad de instalaciones y eventos.","applicant",15,"sebastian.jpg",15,2);
    INSERT INTO profile_account VALUES (null,"Laura","Analista de seguridad informática: Experto en ciberseguridad con habilidades en análisis de riesgos y medidas de protección de sistemas informáticos.","applicant",16,"laura.jpg",16,10);
    INSERT INTO profile_account VALUES (null,"Antonio","Especialista en seguridad física: Habilidad en medidas de prevención y defensa personal en situaciones de emergencia.","applicant",17,"antonio.jpg",17,1);
    INSERT INTO profile_account VALUES (null,"Camila","Coordinadora de seguridad: Habilidad en liderazgo y planeamiento estratégico, garantizando la seguridad en instalaciones y eventos.","applicant",18,"camila.jpg",18,10);
    INSERT INTO profile_account VALUES (null,"José","Técnico de mantenimiento: Habilidad en reparación de equipos y sistemas eléctricos, uso de herramientas manuales y eléctricas.","applicant",19,"jose.jpg",19,12);
    INSERT INTO profile_account VALUES (null,"Gabriela","Especialista en limpieza: Habilidad en manejo de productos químicos y técnicas de limpieza, garantizando espacios seguros y limpios.","applicant",20,"gabriela.jpg",20,11);
    INSERT INTO profile_account VALUES (null,"Carlos","Chofer: Habilidad en conducción segura, mantenimiento y reparación de vehículos, garantizando el traslado seguro de personas o mercancías.","applicant",21,"carlos.jpg",21,2);
    INSERT INTO profile_account VALUES (null,"Luis","Recepcionista: Habilidad en atención telefónica, atención al cliente y manejo de paquetes de oficina.","applicant",22,"luis.jpg",22,3);
    INSERT INTO profile_account VALUES (null,"Victoria","Técnica en radiología: Habilidad en diagnóstico por imágenes, seguridad radiológica y interpretación de imágenes, garantizando un servicio de alta calidad.","applicant",23,"victoria.jpg",23,4);
    INSERT INTO profile_account VALUES (null,"Valentina","Médico general: Habilidad en diagnóstico médico y evaluación clínica, garantizando la atención y tratamiento de afecciones médicas.","applicant",24,"valentina.jpg",24,5);
    INSERT INTO profile_account VALUES (null,"Oscar","Especialista en terapia física: Habilidad en terapia física, rehabilitación y trabajo en equipo, ayudando a los pacientes a recuperar su movilidad y mejorar su calidad de vida.","applicant",25,"oscar.jpg",25,5);
    INSERT INTO profile_account VALUES (null,"Andrea","Especialista en cuidados paliativos: Habilidad en atención al paciente y su entorno familiar, ofreciendo cuidados paliativos de alta calidad.","applicant",26,"andrea.jpg",26,2);
    INSERT INTO profile_account VALUES (null,"Manuel","Supervisor de seguridad: Habilidad en liderazgo y coordinación de equipos de seguridad, garantizando la seguridad en instalaciones y eventos.","applicant",27,"manuel.jpg",27,2);
    INSERT INTO profile_account VALUES (null,"Luciana","Especialista en medicina interna: Habilidad en diagnóstico y tratamiento de enfermedades crónicas, brindando atención integral a pacientes.","applicant",28,"luciana.jpg",28,6);
    INSERT INTO profile_account VALUES (null,"Mariluz","Especialista en cirugía: Habilidad en diagnóstico y tratamiento quirúrgico de enfermedades, garantizando la seguridad del paciente.","applicant",29,"mariluz.jpg",29,5);
    INSERT INTO profile_account VALUES (null,"Pablo","Especialista en ginecología y obstetricia: Habilidad en diagnóstico y tratamiento de enfermedades ginecológicas, garantizando la seguridad del paciente en procesos obstétricos.","applicant",30,"pablo.jpg",30,7);



    INSERT INTO profile_account VALUES (null,"Ecopetrol","Ecopetrol es un grupo integrado de energía, que participa en todos los eslabones de la cadena de hidrocarburos (exploración, producción, transporte, refinación y comercialización) y en infraestructura lineal","company",1,"ecopetrol.jpg",31,7);
    INSERT INTO profile_account VALUES (null,"Claro","Claro es una subsidiaria de América Móvil, el proveedor líder de servicios de telecomunicaciones en América Latina con operaciones en 18 países del Continente Americano y del Caribe.","company",2,"claro.jpg",32,1);
    INSERT INTO profile_account VALUES (null,"Terpel","Terpel es una compañía de origen, tradición y talante colombiano que durante 50 años ha estado comprometida con el país, promoviendo su desarrollo, creciendo de la mano de sus afiliados.","company",3,"terpel.jpg",33,10);
    INSERT INTO profile_account VALUES (null,"Éxito","Los almacenes éxito se caracterizan por ser de gran superficie, en donde se ofrecen todo tipo de productos de mercado y para el hogar, usualmente cuentan con panadería y restaurante dentro del supermercado.","company",4,"exito.jpg",34,18);
    INSERT INTO profile_account VALUES (null,"EPM","EPM es una empresa de servicios públicos domiciliarios que tiene una historia para contar, con cifras y hechos de una responsabilidad social y ambiental que le da sentido a su origen y a su estrategia de negocios.","company",5,"epm.jpg",35,15);
    INSERT INTO profile_account VALUES (null,"Alkosto","Alkosto es una cadena de almacenes colombiana, comercializadora de electrodomésticos, mercado, llantas, tecnología, motos y productos del hogar, de propiedad del Grupo Corbeta.","company",6,"alkosto.jpg",36,13);
    INSERT INTO profile_account VALUES (null,"D1","D1, es la compañía con más puntos de venta en Colombia, alcanza 2.000 tiendas lo que significa estar cada vez más cerca de todos los hogares colombianos, cubriendo el 87% del territorio, en 28 departamentos y 450 municipios.","company",7,"d1.png",37,11);
    INSERT INTO profile_account VALUES (null,"Olímpica","Somos reconocidos como una compañía líder en la comercialización de productos de consumo masivo de óptima calidad, a través de una cadena privada de establecimientos.","company",8,"olimpica.png",38,12);
    INSERT INTO profile_account VALUES (null,"EPS Sura","A través de la Compañía de Servicio de Salud IPS Suramericana S.A., la EPS cuenta con divisiones asistenciales para apoyar su gestión con entidades como: IPS Punto de Salud, Dinámica IPS, Salud en Casa.","company",9,"epssura.jpg",39,7);
    INSERT INTO profile_account VALUES (null,"Codensa","Codensa S.A. ESP es una empresa de distribución y comercialización de energía eléctrica, líder en el mercado, con más de 3'400.000 clientes.","company",10,"codensa.jpg",40,4);
    INSERT INTO profile_account VALUES (null,"Sanitas","En la actualidad, ofrecemos productos y servicios adaptados a las necesidades reales de salud de las personas en todas las etapas de su vida.","company",11,"sanitas.jpg",41,5);
    INSERT INTO profile_account VALUES (null,"Drummond","En el 2021 cumplimos seis años consecutivos de ser los mayores productores y exportadores de carbón — cerca de 32 millones de toneladas transportadas a más de 24 países alrededor del mundo.","company",12,"drummond.png",42,10);
    INSERT INTO profile_account VALUES (null,"Bavaria","La sociedad tiene como objeto Principal la fabricación de cervezas; la producción y transformación de bebidas alimenticias,fermentadas o destiladas, así como la fabricación, producción, y transformación de toda clase se debidas.","company",13,"bavaria.jpg",43,19);
    INSERT INTO profile_account VALUES (null,"Primax ","Es una empresa que opera principalmente en el sector Petróleo y Gas y Energía Eléctrica. Conecta con sus contactos clave, proyectos, accionistas, noticias relacionadas y más.","company",14,"primax.png",44,18);
    INSERT INTO profile_account VALUES (null,"Emgesa","Descripción: Emgesa S.A. E.S.P. es una empresa colombiana dedicada a la generación eléctrica para el mercado mayorista y clientes industriales del mercado desregulado.","company",15,"emgesa.jpg",45,15);
    INSERT INTO profile_account VALUES (null,"Salud Total","Ofrecemos servicios de salud con Calidad Total, Salud Total EPS es una Entidad Promotora de Salud líder en el mercado brindando servicios con calidad y cubrimiento en el territorio nacional.","company",16,"saludtotal.png",46,10);
    INSERT INTO profile_account VALUES (null,"Homecenter","Su actividad se focaliza en desarrollar y proveer soluciones a los proyectos de remodelación y construcción de sus clientes, además de satisfacer las necesidades de mejoramiento y decoración de sus hogares.","company",17,"homecenter.png",47,9);
    INSERT INTO profile_account VALUES (null,"Cencosud","Cencosud S.A. es una Compañía con presencia en cinco países de América Latina (Chile, Argentina, Brasil, Perú y Colombia), en Estados Unidos y en China -con una oficina comercial.","company",18,"cencosud.png",48,2);
    INSERT INTO profile_account VALUES (null,"Medimás EPS","Medimás, llega como una nueva entidad creada por el consorcio Prestasalud y está habilitada para prestar el servicio de salud tanto en el Régimen Contributivo, como en el Régimen Subsidiado.","company",19,"medimas.jpg",49,5);
    INSERT INTO profile_account VALUES (null,"Compensar","Compensar como entidad de Seguridad Social facilita a sus afiliados, a través de los Planes de Bienestar, un amplio portafolio de servicios que le permite,generar condiciones que favorecen el desarrollo personal.","company",20,"compensar.jpg",50,16);
    INSERT INTO profile_account VALUES (null,"Samsung Colombia","Samsung es un conglomerado de empresas multinacionales con sede en Seúl, Corea del Sur. Se trata del mayor grupo empresarial surcoreano, con numerosas filiales que abarcan negocios como la electrónica de consumo.","company",21,"samsung.png",51,8);
    INSERT INTO profile_account VALUES (null,"Avianca","La red de rutas Avianca es una de las más amplias de Latinoamérica, operando en sus aviones de corto, mediano y largo alcance, vuelos a 108 destinos en América y Europa en 26 países.","company",22,"avianca.jpg",52,3);
    INSERT INTO profile_account VALUES (null,"Coomeva EPS","Somos un Grupo Empresarial Cooperativo cuya entidad matriz es Coomeva Cooperativa, conformada por profesionales que se asocian para satisfacer necesidades comunes.","company",23,"coomeva.jpg",53,20);
    INSERT INTO profile_account VALUES (null,"Audifarma","dedicada al comercio al por mayor y al por menor de productos farmacéuticos medicinales, cosméticos y tocador. La empresa es un gestor farmacéutico integral, brindando soluciones globales a los clientes.","company",24,"audifarma.jpg",54,5);
    INSERT INTO profile_account VALUES (null,"Cementos Argos","Cementos Argos es una compañía líder en la producción de cemento y concreto en los mercados en los que tiene presencia. Hoy es la primera productora en cemento y concreto en Colombia.","company",25,"argos.png",55,7);
    INSERT INTO profile_account VALUES (null,"Postobon","Postobón es la compañía de bebidas líder en Colombia, que con la diversidad de productos y sabores que ofrece genera sensaciones únicas a sus consumidores.","company",26,"postobon.jpg",56,3);
    INSERT INTO profile_account VALUES (null,"Alpina","Alpina Productos Alimenticios S.A. es una empresa multinacional colombiana productora de alimentos a base de lácteos. Tiene operación en Colombia, Ecuador, Venezuela y Estados Unidos y comercializa sus productos en centro América.","company",27,"alpina.jpg",57,4);
    INSERT INTO profile_account VALUES (null,"Cemex Colombia","CEMEX es una compañía global de materiales para la industria de la construcción que ofrece productos de alta calidad y servicios confiables a clientes y comunidades en América, Europa, África, Medio Oriente y Asia.","company",28,"cemex.jpg",58,14);
    INSERT INTO profile_account VALUES (null,"Italcol","Italcol es una empresa colombiana especializada en la producción, distribución, venta y exportación de alimentos concentrados para todas las especies pecuarias, venta de materias primas y premezclas.","company",29,"italcol.png",59,12);
    INSERT INTO profile_account VALUES (null,"Makro","Makro: autoservicio mayorista, comercializa productos en las áreas de alimentos secos, alimentos perecederos y no alimentos. Bajo el concepto 'PAGUE Y LLEVE' y la estrategia de mejor calidad al más bajo precio.","company",30,"makro.png",60,1);
    ...
    INSERT INTO specific_interest VALUES (null,"Product manager",1 );
