...
const totalSectionOp = ()=>{
    ...
    const encabezado = encaCreator('Registro Usuario - Empresa')/*, 'https://imgs.search.brave.com/6qhMR1Aw9nsEP5rgfTySp-8ddBIscTUWEjnUFItY1lE/rs:fit:320:320:1/g:ce/aHR0cHM6Ly9jcG5n/LnBpa3BuZy5jb20v/cG5nbC9zLzUyMS01/MjE5Mzg0X2VxdWlz/LXN0aWNrZXItc3Zn/LWljb24tY2xvc2Ut/Y2xpcGFydC5wbmc'*/

    const section1 = sectionOne()
    const section2 = sectionTwo()

    const btn = buttonCreator("interestButton")
